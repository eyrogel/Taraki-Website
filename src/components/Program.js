      ...
      <div>
        <div className="cont">
          <section className="mt-16 tablet:mt-12 text-center">
            <h1 className="font-semibold text-md tablet:text-lg tablet-m:text-2xl px-20 tablet:px-52 tablet-m:px-72 laptop-s:text-3xl laptop-s:mx-36 laptop-m:text-[2.3rem] laptop-m:mx-52 laptop-s:py-6 laptop-m:py-8">
          ...
          >
            <div
              className="mx-auto mt-5 rounded-lg bg-cover bg-center w-72 h-52 tablet:w-[115rem] tablet-m:w-[130rem] tablet:h-[14rem] laptop-s:w-[180rem] laptop-m:w-[190rem] laptop-s:h-[20rem]"
            ...
            >
              <h1 className="text-center tablet:text-left text-sm tablet:text-[0.9rem] tablet-m:text-xl laptop-s:text-2xl laptop-m:text-[2rem] font-semibold mt-5 px-8 tablet:px-0">
                AWARENESS PROGRAM
              </h1>
              <p className="text-sm tablet:text-[0.9rem] tablet-m:text-lg laptop-s:text-[1.3rem] laptop-m:text-[1.4rem] tablet:font-normal tablet:leading-6 text-center tablet:text-left font-light mt-2 tablet:mt-4 px-8 tablet:px-0">
          ...
          >
            <div
              className="mx-auto mt-5 rounded-lg bg-cover bg-center w-72 h-52 tablet:w-[100rem] tablet-m:w-[130rem] tablet:h-[14rem] tablet:order-2 laptop-s:w-[130rem] laptop-m:w-[140rem] laptop-s:h-[20rem]"
            ...
            >
              ...
              <p className="text-sm tablet:text-[0.9rem] tablet-m:text-lg laptop-s:text-[1.3rem] laptop-m:text-[1.4rem] tablet:font-normal tablet:leading-6 text-center tablet:text-left font-light mt-2 tablet:mt-4 px-8 tablet:pl-0 tablet:pr-5">
          ...
          >
            <div
              className="mx-auto mt-5 rounded-lg bg-cover bg-center w-72 h-52 tablet:w-[110rem] tablet-m:w-[125rem] tablet:h-[14rem] laptop-s:w-[170rem] laptop-m:w-[180rem] laptop-s:h-[20rem]"
          ...
          >
            <div
              className="mx-auto mt-5 rounded-lg bg-cover bg-center w-72 h-52 tablet:w-[85rem] tablet-m:w-[110rem] tablet:h-[14rem] tablet:order-2 laptop-s:w-[114rem] laptop-m:w-[124rem] laptop-s:h-[20rem]"
