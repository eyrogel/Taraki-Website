      ...
      <div className="font-satoshi overflow-x-hidden">
        <div className="cont tablet:px-8">
          <section className="mt-16 tablet:mt-12 text-center">
            <h1 className="font-semibold text-md tablet:text-lg tablet-m:text-2xl laptop-s:text-3xl">
              Taraki's Team
            </h1>
            <p className="font-light tablet:font-normal tablet:leading-6 text-sm tablet:text-md tablet-m:text-lg tablet-m:px-24 tablet:px-20 px-10 mt-5 tablet:mt-2 laptop-s:text-xl">
            ...
            <div className="laptopCont px-0 hidden tablet-m:flex justify-between items-center">
              ...
              <div className="shadow-lg bg-white flex flex-col justify-center items-center w-[100%] tablet:w-full tablet:my-4  tablet:h-64 tablet-m:w-[30%] tablet-m:h-[36rem] h-[26rem] my-5">
                ...
                <div className="flex flex-col justify-center px-2 py-2 tablet:px-3">
                  ...
                  <p className="bg-white font-extralight text-[0.8rem] tablet:mt-2 tablet-m:mt-6 tablet:text-[1rem] tablet-m:text-[1.1rem] leading-relaxed">
                  Jezelle is a seasoned technologist with a passion for cutting-edge innovations. He oversees all technology initiatives, ensuring TARAKI remains at the forefront of industry advancements.
                  </p>
                  <section className="flex space-x-7 tablet:space-x-8 mt-1 tablet:mt-2 tablet-m:mt-6">
                    <svg
                      className="tablet:w-8 h-8"
