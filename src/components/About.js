      ...
      <div className="font-satoshi overflow-x-hidden">
        <div className="cont tablet:flex tablet:justify-between tablet:items-center tablet:mt-10 tablet:px-8">
          <section className="text-center tablet:text-left mt-16 tablet:mt-0">
            <h1 className="font-semibold text-md tablet:text-lg tablet-m:text-2xl tablet:px-0 laptop-s:text-3xl">
              About Us
            </h1>
            <p className="font-light text-sm tablet:text-md tablet-m:text-xl laptop-s:text-2xl px-10 tablet:px-0 mt-5 tablet:mt-0 tablet-m:mr-5 tablet-m:mt-4 tablet:leading-6 tablet-m:leading-8">
